...
@Named
@Singleton
public class DefaultP2TychoRepositoryAggregator
    implements P2TychoRepositoryAggregator
{
    ...
    private File getP2Artifacts( final P2TychoRepositoryAggregatorConfiguration configuration, final Repository repository )
        throws Exception
    {
